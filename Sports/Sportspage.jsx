                ...
                <div className="row">
                  <div  style={{position:"relative"}}>
                        ...
                        <div className="col-4 col-md-2">
                            <h3 className="school-title-2">Event Name:</h3>
                            <h3 className="school-title-2">Event.Date:</h3>
                            <h3 className="school-title-2">Description:</h3>
                            <h3 className="school-title-2" style={{ marginTop: "65px" }}>Photo/Video</h3>
                            <h3  className="school-title-2" style={{ marginTop: "15px" }} >Select Files:</h3>
                            
   {/* // let[sports,setsports]=useState({eventname:"",day:"",month:"",year:"",Description:"",uploadimages:""}) */}
                        </div>
                         
                        <div className="col-4 col-md-2">
                        <input type="text" ref={ref1} className='form-control std_rec_add1 ip-12' placeholder='Event Name' onChange={e=>setsports({...sports1, eventname:e.target.value})} ></input>
                        <div className="d-flex">
                                <input type="text" ref={ref2} className='form-control std_rec_add1 ed-12 '   placeholder='Day'  onChange={e=>setsports({...sports1, day:e.target.value})} ></input>
                                <input type="text" ref={ref3} className='form-control std_rec_add1 ed-12'  placeholder='Month' onChange={e=>setsports({...sports1, month:e.target.value})} ></input>
                                <input type="text" ref={ref4} className='form-control std_rec_add1 ed-12'   placeholder='Year' onChange={e=>setsports({...sports1, year:e.target.value}) } ></input>
       ...
       <select className="form-control mt-2 ip-12" ref={ref6} onChange={e=>setCT(e.target.value)}>
        <option className="ip-12">selectt</option>
